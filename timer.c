...
//void TA2_0_IRQHandler(void) {
    ...
    //}
//}
void setTimer(uint32_t timeInSeconds) {
    uint32_t timerPeriod = (3000000 / 64) * timeInSeconds; // Calculate period for SMCLK/64
    Timer_A_setCompareValue(TIMER_A0_BASE, TIMER_A_CAPTURECOMPARE_REGISTER_0, timerPeriod);
    Timer_A_clearTimer(TIMER_A0_BASE); // Clear the timer
}
